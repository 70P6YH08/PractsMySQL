...
(1, 'SimCity', 'Градостроительный ЕГОР симулятор снова с вами! Создайте город своей мечты', 'Симулятор', '1499.00'),
(2, 'TITANFALL', 'Эта игра перенесет вас ЕГОР во вселенную, где малое противопоставляется ЕГОР большому, природа – индустрии, а человек – машине', 'Шутер', '2299.00'),
...
(4, 'The Sims 4', 'В реальности ЕГОР каждому человеку ЕГОР дано прожить лишь одну жизнь. Но с помощью ЕГОР The Sims 4 это ограничение можно снять! Вам решать — где, как и с кем жить, чем заниматься, чем украшать и обустраивать свой дом', 'Симулятор', '15.00'),
(5, 'Dark Souls 2', 'Продолжение знаменитого ЕГОР ролевого экшена вновь заставит игроков ЕГОР пройти через сложнейшие испытания. Dark ЕГОР Souls II предложит нового героя, новую историю и новый мир. Лишь одно неизменно – выжить в мрачной вселенной Dark Souls очень непросто.', 'RPG', '949.00'),
