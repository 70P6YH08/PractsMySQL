...
-- Schema pr1
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `pr1` DEFAULT CHARACTER SET utf8mb3 ;
SHOW WARNINGS;
USE `pr1` ;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pr1`.`books_info` (
...
-- Table `pr1`.`games`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pr1`.`games` (
...
-- -----------------------------------------------------
-- Table `pr1`.`my_event_table`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pr1`.`my_event_table` (
...
-- Table `pr1`.`tempbooks`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pr1`.`tempbooks` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pr1`.`video_games` (
...
-- Table `pr1`.`shipment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pr1`.`shipment` (
